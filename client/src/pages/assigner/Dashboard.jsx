...
const AssignerDashboard = () => {
  ...
  const getDefaultColumnConfig = () => ({
    ...
    assignedRadiologist: { visible: true,  order: 18, label: 'Radiologist' },
    studyLock:           { visible: true,  order: 19, label: 'Lock/Unlock' },
    status:              { visible: true,  order: 20, label: 'Status' },
    printCount:          { visible: true,  order: 21, label: 'Print Report' },
    rejectionReason:     { visible: true,  order: 22, label: 'Reverted Reason' },
