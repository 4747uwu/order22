            ...
            <div className="flex items-center space-x-1">
              ...
              {additionalActions.map((action, index) => (
                <button
                  ...
                  className={`hidden md:flex items-center space-x-1 px-2 py-1 rounded text-xs font-medium transition-colors border ${
              ...
              {notifications > 0 && (
                <button className="relative p-1.5 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded transition-colors">
                  ...
                  <span className="absolute -top-0.5 -right-0.5 h-3.5 w-3.5 bg-red-500 text-white text-[9px] rounded-full flex items-center justify-center font-bold">
              ...
              <div className="relative" ref={profileDropdownRef}>
                <button
                  ...
                  className="flex items-center space-x-1.5 bg-gray-100 border border-gray-300 rounded px-2 py-1 hover:bg-gray-200 focus:outline-none transition-colors"
                >
                  ...
                  <span className="hidden sm:block text-xs font-medium text-gray-900 truncate max-w-20">
                    {currentUser?.fullName?.split(' ')[0]}
                  </span>
                  <ChevronDown className={`h-3 w-3 text-gray-400 transition-transform ${showProfileDropdown ? 'rotate-180' : ''}`} />
                </button>
