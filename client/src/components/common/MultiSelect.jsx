...
const MultiSelect = ({ 
    ...
    return (
        <div ref={dropdownRef} className={`relative flex-shrink-0 ${className}`}>
            ...
            {isOpen && (
                <div className="absolute z-50 w-full mt-1 bg-white border border-gray-300 rounded shadow-lg min-w-max">
                    {/* Search Input */}
                    {searchable && (
                            ...
                            filteredOptions.map((option) => (
                                ...
                                >
                                    ...
                                    {selected.includes(option.value) && (
                                        <Check size={12} className="text-green-600 flex-shrink-0 ml-2" />
                                    )}
                                </div>
                            ))
                        )}
